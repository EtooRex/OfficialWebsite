...
const docsUrl = ref('http://localhost:5174/')
...
const refreshDocs = () => {
  ...
  docsUrl.value = `http://localhost:5174/docs/?t=${timestamp}`
}
...
onMounted(() => {
  ...
  // Set initial URL to docs index
  docsUrl.value = 'http://localhost:5174/docs/'
      ...
      <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          <div class="p-6 border-b border-gray-200">
            ...
            <p class="text-gray-600 mt-2">
              Complete documentation with search, navigation, and responsive design.
            </p>
          </div>
          
          <!-- Embedded VitePress Documentation -->
        ...
        <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <p class="text-gray-600 mb-4">Learn the basics of AEROS and get your first simulation running.</p>
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <p class="text-gray-600 mb-4">Detailed documentation for AeROS® and Weibull Toolbox® products.</p>
            <a href="http://localhost:5174/guide/aeros" target="_blank" class="text-primary font-medium hover:underline">View Products →</a>
          </div>
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <p class="text-gray-600 mb-4">Complete API documentation with authentication and code examples.</p>
            <a href="http://localhost:5174/api/" target="_blank" class="text-primary font-medium hover:underline">View API Docs →</a>
          </div>
        </div>
      </div>
    </main>
