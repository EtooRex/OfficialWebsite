      ...
      <div class="bg-white p-8 rounded-lg shadow-xl mb-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <h4 class="text-lg font-semibold text-dark mb-2">Industry Compliance</h4>
            <p class="text-gray-600">Built-in compliance features for regulated heavy asset industries.</p>
          </div>
        </div>
      </div>
