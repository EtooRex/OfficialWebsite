...
const features = [
  {
    ...
    description: "Powerful simulation tools for complex engineering problems with real-time feedback and visualization.",
    icon: "M19.424 4.573a1 1 0 10-1.092-1.677l-12 7.8a1 1 0 00-.02 1.695l12 8.4a1 1 0 001.137-1.647L8.002 11.8l11.422-7.227z M5.424 4.573a1 1 0 111.092-1.677l12 7.8a1 1 0 01.02 1.695l-12 8.4a1 1 0 01-1.137-1.647L16.848 11.8 5.424 4.573z"
  },
  {
    title: "Design Optimization",
    description: "AI-powered design optimization that helps you find the best solutions for your engineering challenges.",
    icon: "M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"
  },
  {
    title: "Collaborative Workspace",
    description: "Work together with your team in real-time, share designs, and collaborate on complex projects.",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"
  },
  {
    title: "Cloud Computing",
    description: "Leverage the power of cloud computing to run complex simulations without the need for expensive hardware.",
  ...
  <section class="py-20 bg-gray-50">
    <div class="container mx-auto px-4">
      <div class="text-center mb-16">
        <h2 class="text-3xl md:text-4xl font-bold text-dark mb-4">Powerful Features</h2>
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          AEROS provides cutting-edge tools for engineers and designers to create better products faster.
        </p>
      </div>
