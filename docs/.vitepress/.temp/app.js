...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"EtooreRex Learn","description":"Comprehensive learning resources for reliability engineering","base":"/learn/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Home","link":"/"},{"text":"Documentation","link":"/documentation/"},{"text":"Tutorials","link":"/tutorials/"},{"text":"API Reference","link":"/api/"}],"sidebar":{"/documentation/":[{"text":"Getting Started","items":[{"text":"Introduction","link":"/documentation/"}]},{"text":"AeROS®","items":[{"text":"Overview","link":"/documentation/aeros/"}]},{"text":"Weibull Toolbox®","items":[{"text":"Overview","link":"/documentation/weibull/"}]}],"/tutorials/":[{"text":"Video Tutorials","items":[{"text":"Getting Started","link":"/tutorials/"}]}],"/api/":[{"text":"API Reference","items":[{"text":"Introduction","link":"/api/"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/etoorerex"}],"footer":{"message":"Released under the MIT License.","copyright":"Copyright © 2025 EtooreRex"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'));
